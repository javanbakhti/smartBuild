          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <p className="text-muted-foreground">Manage shared services and contacts for the building.</p>
              </div>
            ...
            {isLoading ? (
              <div className="flex justify-center items-center py-10">
                ...
                <div className="text-center py-10 text-muted-foreground bg-slate-50 dark:bg-slate-800/50 rounded-lg">
                    ...
                    <p>Click "Add New Contact" to build the community directory.</p>
                </div>
            ) : viewMode === 'grid' ? (
