import React from 'react';
    ...
    import { MoreHorizontal, Edit3, Trash2, QrCode, CheckCircle, XCircle, AlertCircle, CalendarDays, Clock, Mail, ArrowUpDown, Archive as ArchiveIcon, AlertTriangle as WarningIcon } from 'lucide-react';
    ...
    const ResidentVisitorTable = ({ 
      ...
      const getStatusIcon = (status) => {
        switch (status) {
          ...
          case 'archived': return <ArchiveIcon className="h-4 w-4 text-slate-500 mr-2" />;
          default: return null;
        }
      };
                ...
                <TableRow key={visitor.id} className="dark:border-slate-700 hover:bg-muted/50 dark:hover:bg-slate-700/50">
                  ...
                  <TableCell className="dark:text-gray-300">
                    <div className="flex items-center">
                      ...
                      ) : <span className="text-green-500 dark:text-green-400">Single Entry</span>}
                      ...
                      <DropdownMenuContent align="end" className="dark:bg-slate-800 dark:border-slate-700">
                        ...
                        {isArchiveTable && onUnarchive && (
                            <DropdownMenuItem onClick={() => onUnarchive(visitor.id)} className="dark:text-blue-400 dark:hover:bg-slate-700">
                                <ArchiveIcon className="mr-2 h-4 w-4" /> Unarchive
                            </DropdownMenuItem>
                        )}
    ...
    export default ResidentVisitorTable;